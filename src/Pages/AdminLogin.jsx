...
export default function AdminLogin() {
  ...
  return isLoading === true ? (<div style={{ display: "flex", height: "100vh", justifyContent: "center", alignItems: "center" }}>Loading...</div>) : (
    <Flex
      minH={'100vh'}
      align={'center'}
      justify={'center'}
    ...
    >
      <Stack spacing={8} mx={'auto'} py={12} px={6}>
        <Stack align={'center'}>
          <Heading fontSize={'4xl'} color={"gold"}>Gleams </Heading>
