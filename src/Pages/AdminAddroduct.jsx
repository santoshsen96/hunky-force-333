...
import { addProductWatch, addProductWatchToProduct } from '../Redux/AdminProduct/action'
...
export const AdminAddroduct = () => {
  const [product, setProduct] = useState(initialState)
    ...
    const { id, image, title, brand, discount, gender, size, price, category } = product
  ...
  return (
    ...
    <Flex className='addproductpagecontainer' justifyContent={"space-evenly"} >
        ...
        <Box className='formcontainer' textAlign={"center"} w={"82%"}>
            ...
            <Heading color={"#2d2d2d"} marginBottom="2%" marginTop="-9%">ADD PRODUCT</Heading>
